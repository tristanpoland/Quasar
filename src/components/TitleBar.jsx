  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 flex-1 ml-4">
        ...
        <div
          className="flex items-center gap-2 px-3 py-1.5 bg-gray-900 rounded-lg cursor-pointer flex-1 max-w-xl"
          onClick={() => {
        ...
        >
          ...
          <span className="text-gray-400 text-sm">Search commands... (⌘K)</span>
        </div>
      </div>
